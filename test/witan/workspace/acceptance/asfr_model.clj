(ns witan.workspace.acceptance.asfr-model
...
(def catalog
  [{:witan/fn :witan.workspace.acceptance.asfr-model/births, :witan/name :births}
   {:witan/fn :witan.workspace.acceptance.asfr-model/get-births-data-year, :witan/name :get-births-data-year}
   {:witan/fn :witan.workspace.acceptance.asfr-model/births-pool, :witan/name :births-pool}
   {:witan/fn :witan.workspace.acceptance.asfr-model/estimated-sya-births-pool, :witan/name :estimated-sya-births-pool}
   {:witan/fn :witan.workspace.acceptance.asfr-model/at-risk-this-fert-last-year, :witan/name :at-risk-this-fert-last-year}
   {:witan/fn :witan.workspace.acceptance.asfr-model/fert-rate-without-45-49, :witan/name :fert-rate-without-45-49}
   {:witan/fn :witan.workspace.acceptance.asfr-model/historic-fertility, :witan/name :historic-fertility}
   {:witan/fn :witan.workspace.acceptance.asfr-model/fert-rate-with-45-49, :witan/name :fert-rate-with-45-49}
   {:witan/fn :witan.workspace.acceptance.asfr-model/estimated-sya-births, :witan/name :estimated-sya-births}
   {:witan/fn :witan.workspace.acceptance.asfr-model/scaling-factors, :witan/name :scaling-factors}
   {:witan/fn :witan.workspace.acceptance.asfr-model/actual-births, :witan/name :actual-births}
   {:witan/fn :witan.workspace.acceptance.asfr-model/at-risk-last-birth-year, :witan/name :at-risk-last-birth-year}
